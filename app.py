...
with st.expander("Como rodar o streamlit?"):
    ...
    st.caption("Onde app.py é o arquivo principal do Streamlit")

with st.expander("Posso rodar o streamlit em outra porta?"):
    st.success("Sim, basta passar a porta que deseja")
    st.text("No terminal digite")
    st.code("streamlit run app.py --server.port 8080")
    st.caption("Onde app.py é o arquivo principal do Streamlit e 8080 é a porta")
